...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <style>
        ...
        body{
             background-image:url("imgs/usr.jpg");
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <label>Height</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox9" runat="server" placeholder="Height"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>Weight</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox6" runat="server" placeholder="Weight"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
